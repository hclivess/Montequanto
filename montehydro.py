...
class TexasRanger:
    ...
    def spawn_child(self):
        if self.weight > 70 and self.y_position % 50 == 0 and not self.curve_match:
            spawn_walker(self.x_position + random.randint(-5, 5), self.y_position + random.randint(-5, 5), self.curve, color=green)
